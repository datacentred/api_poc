...
user1 = organization1.users.create! uuid:       "1",       email: "bill.s.preston@bodacious.com",
                                    first_name: "Bill S.", last_name: "Preston",
                                    password:   "password"
user2 = organization2.users.create! uuid:       "2",              email: "ted.t.logan@tubular.com",
                                    first_name: "Ted 'Theodore'", last_name: "Logan",
                                    password:   "password"
user3 = organization1.users.create! uuid:       "3",         email: "elizabeth@ironmaiden.com",
                                    first_name: "Elizabeth", last_name: "Princess",
                                    password:   "password"
user4 = organization2.users.create! uuid:       "4",      email: "joanna@ironmaiden.com",
