...
module Harbour
  class ApplicationControllerTest < ApiTest
    ...
    test "enforces content type to be JSON for payloads" do
      ...
      post '/api/roles', params: params.to_xml, headers: authorized_headers.merge(
    ...
    test "meaningful error for incorrect API versions" do
      ...
      get '/api/roles', headers: authorized_headers.merge(
        "Accept" => "application/vnd.datacentred.api+json; version=999999999"
      )
      assert_response :not_acceptable
